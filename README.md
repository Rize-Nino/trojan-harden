此脚本非独立项目，仅为解决Jrohy老师脚本存在的安全性问题的牺牲性方案。
...
脚本安全问题原文：https://github.com/ainrm/Jrohy-trojan-unauth-poc/blob/main/README.md
...
使用须知 & 安全建议：
1.此脚本会牺牲掉通过web管理用户的功能；
2.此脚本不能适用于所有系统及环境（问题多见于源失效导致的组件缺失）；
3.建议使用密钥登入SSH，禁用密码登入功能，将端口号更改为22以外的非常规端口，并妥善保管密钥文件，不要泄漏；
